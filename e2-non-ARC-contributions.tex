...
%------------------------------------------------
\subsubsection*{A/Prof Peter Strazdins (in-kind Salary Level D2, 0.15 FTE)}
A/Professor  Peter Strazdins’ salary (15\% of Academic Level D2 at ANU) 
and on-costs of 30\% and cash contribution of 1.55\% 
(difference between ANU and ARC on-cost percentage) are
directly contributed by the Australian National University. 
...
\begin{description}
\item[Year 1 - 2017] ICSE 2017: SPLASH. Cost \$5,709  (see E1 justification).

\item[Year 2 - 2018] ICSE 2018.  Cost \$5,421  (see E1 justification).

\item[Year 3 - 2019] CHI.  Cost \$5,007  (see E1 justification).
...
\begin{description}
\item[Year 1 - 2017] SIAM CSE 2017.  Cost \$6,235   (see E1 justification).

\item[Year 2 - 2018] SIAM UQ 2018.  Cost \$6,410  (see E1 justification).
