...
The ANU will cover the difference between ARC and ANU salary rates. The on-costs gap of 2.55\% will entail an ANU cash constribution of  \$8,214 over the three years of appointment.


%------------------------------------------------
\subsubsection*{Research Associate – Mathematics (Level B1, 1.0 FTE)}

The ANU will cover the difference between ARC and ANU salary rates. The on-costs gap of 2.55\% will entail an ANU cash constribution of  \$7,379 over the three years of appointment.
...
\item[Year 3 - 2020] CHI 2020.  Cost \$5,616 (see E1 justification).

\item[Year 4 - 2021] ICSE 2019. Cost \$6,015 (see E1 justification).
...
\item[Year 2 - 2019] SIAM UQ 2019.  Cost \$5,406  (see E1 justification).
...
NCI rate of 4c/service Unit. Total \$6,000/year (pro rata to 0.5 years in the fourth year of the project). 
