...
The project described in this application is core to a larger context for our work as 
 shown in Figure 1. We envision a context where real-time and rapidly-varying human demands for 
 simulation results will derive the development of appropriate interfaces and modelling infrastructure including uncertainty. 
 Such simulations will be running on heterogenous HPC compute systems which, themselves, may need to be optimised and redistributed in real-time because of the volatile nature of the deployed environment. Both layers of the simulation environment will be developed and deployed using live-coding infrastructure. This discovery grant addresses the vertical box in this diagram in order to understand and have confidence in the core mathematical and computational principles behind the quantification of uncertainty for innudation models, and their deployment onto heterogenous and volatile HPC resources using live-coding. 
\begin{figure}
  \begin{center}
