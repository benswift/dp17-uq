...
techniques~\cite{BungartzGriebel2004} \todo{more refs?} 
...
method~\cite{JakemanRoberts2013}.
...
In particular, the addition of gradient estimates to the sparse grid surrogate, 
the extension to a more probablistic sparse grid model (akin to kriging) and
and how these enhance the quantification of uncertainty will be investigated.
