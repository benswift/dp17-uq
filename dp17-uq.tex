\documentclass[a4paper,fontsize=12.1pt]{scrartcl}
\pagestyle{empty}
\usepackage{geometry}
\geometry{total={170mm,257mm},
left=20mm,
top=20mm}
\usepackage{times} % a times new roman clone apparantly
%\usepackage{Alegreya}
%\usepackage{AlegreyaSans}
% The following two lines for true Times New Roman with XeLaTeX
%\usepackage{fontspec}
...
remains a challenge due to the shear number of function evaluations required. 
