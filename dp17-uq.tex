...
\subsubsection*{Applications to design optimisation}

We envisage this project will also have significant benefits to engineering.
We will demonstrate this by considering design optimisation problems,
specifically in design problems in aerospace and engineering. 
This is a significant challenge due to the large number of 
parameters required to describe the geometry of an aircraft wing for example.
...
stages of a flight.
The weather conditions and stresses an aircraft will be exposed to can only be guessed at.
...
This will be demonstrated by using the open source SU2~\parencite{SU2} software within our live coding framework.
