...
authors of this proposal has been working on and with over several
years.
...
high-dimensional parameter spaces. The use of sparse grids will allow
...
\emph{capability} to modify the simulation on-the-fly, the sparse grid
techniques shorten the feedback latency to make this capability
\emph{useful}.
