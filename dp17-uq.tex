...
in floods, fires or earthquakes) information from computational
simulation is needed urgently to aid decision-making by emergency
services. This is not simply a matter of compute power but requires
insight from software engineering, computational mathematics, human
computer interaction, high performance computing and data
visualisation. All of these facets need to be tightly coupled and
tested in realistic team-coordination and decision-making scenarios
where decision-makers collaborate with modelling experts. In
...
develop new environmental simulations of flood surge and tsunamis
which use sparse grids and uncertainty quantification to dramatically
increase the speed, quality and usefulness of model predictions and
their associated uncertainty. We will deploy ``live'' distributed
computing infrastructure to \emph{rapidly prototype} the human
interface to these new environmental simulations and to transform the
traditional, batch-oriented workflow of environmental simulation into
a highly interactive one. We will evaluate team coordination and
...
interfaces for storm-surge and tsunami flood modelling, which
...
the model. We have recently found new ways to incorporate gradient
...
The mathematical component of this project will be based on new
mathematical developments combining sparse
...
ICSE, VL/HCC, Supercomputing (SC), Computer Supported Cooperative Work
