...
Because of the interdisciplinary computer science nature of this project, we anticipate that the Australasian Computer Science Week conference (ACSW) will be one target destination for publication as it has tracks soliciting contributions in Simulation, Software Engineering, Scientific Computing, Human Computer Interaction, Programming Languages and Distributed Systems. In 2016 and 2017, CI Strazdins was the Program Chair for the main track (ACSC) of ACSW. 
